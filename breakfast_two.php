<?php
		...
		{
			$key1 = $_GET['ingredient'][0] ;
   			$key2 = $_GET['ingredient'][1];
    		if(($key1 == "yougart" && $key2 == "self_rising_flour") || ($key1 == "self_rising_flour" && $key2 == "yougart")) 
    		{	
...
<body>
	...
	<form action="breakfast_two.php" method="GET" >
		<fieldset>
